...
def main():
    ...
    try:
        ...
        while(1):
            ...
            if key == 'w':
                target_linear_velocity =\
                    check_linear_limit_velocity(target_linear_velocity + ROBOT_LINEAR_VEL_STEP_SIZE)
                status = status + 1
                ...
                target_angular_velocity =\
                    check_angular_limit_velocity(target_angular_velocity + ROBOT_ANGULAR_VEL_STEP_SIZE)
                status = status + 1
                print_vels(target_linear_velocity, target_angular_velocity)
            elif key == 'd':
                target_angular_velocity =\
